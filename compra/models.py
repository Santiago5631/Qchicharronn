...
class Compra(models.Model):
    ...
    proveedor = models.ForeignKey('proveedor.Proveedor', on_delete=models.CASCADE, null=True, blank=True)
    unidad = models.ForeignKey('unidad.Unidad', on_delete=models.CASCADE, null=True, blank=True)
