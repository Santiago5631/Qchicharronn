...
(function (global, factory) {
  ...
  var ControlSidebar = function ($) {
    ...
    var Selector = {
      CONTROL_SIDEBAR: '.control-aside',
      CONTROL_SIDEBAR_CONTENT: '.control-aside-content',
      DATA_TOGGLE: '[data-widget="control-aside"]',
      CONTENT: '.content-wrapper',
      HEADER: '.main-header',
      FOOTER: '.main-footer'
    };
    var ClassName = {
      CONTROL_SIDEBAR_ANIMATE: 'control-aside-animate',
      CONTROL_SIDEBAR_OPEN: 'control-aside-open',
      CONTROL_SIDEBAR_SLIDE: 'control-aside-slide-open',
    ...
    var ControlSidebar = /*#__PURE__*/function () {
      ...
      _proto.toggle = function toggle() {
        ...
        if (shouldClose) {
          // Close the control aside
          this.collapse();
        } else {
          // Open the control aside
          this.show();
        }
      } // Private
      ;
  ...
  var Layout = function ($) {
    ...
    var Selector = {
      ...
      CONTROL_SIDEBAR: '.control-aside',
      CONTROL_SIDEBAR_CONTENT: '.control-aside-content',
      CONTROL_SIDEBAR_BTN: '[data-widget="control-aside"]',
      LAYOUT_FIXED: '.layout-fixed',
      FOOTER: '.main-footer',
    ...
    var ClassName = {
      ...
      SIDEBAR_FOCUSED: 'aside-focused',
      LAYOUT_FIXED: 'layout-fixed',
      NAVBAR_FIXED: 'layout-navbar-fixed',
      FOOTER_FIXED: 'layout-footer-fixed',
      LOGIN_PAGE: 'login-page',
      REGISTER_PAGE: 'register-page',
      CONTROL_SIDEBAR_SLIDE_OPEN: 'control-aside-slide-open',
      CONTROL_SIDEBAR_OPEN: 'control-aside-open'
    };
    var Default = {
      scrollbarTheme: 'os-theme-light',
  ...
  var PushMenu = function ($) {
    ...
    var Selector = {
      ...
      SIDEBAR_MINI: '.aside-mini',
      SIDEBAR_COLLAPSED: '.aside-collapse',
      BODY: 'body',
      OVERLAY: '#aside-overlay',
      WRAPPER: '.wrapper'
    };
    var ClassName = {
      COLLAPSED: 'aside-collapse',
      OPEN: 'aside-open',
      CLOSED: 'aside-closed'
    };
    /**
